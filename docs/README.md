...
classDiagram
   ...
   class ConfigurationProperty {
    ...
    class ConfigurationManager {
        ...
        + load_properties(filePath: char[]) void
        + get_property(path: char[]) void*
        + free_properties() void
    }
...
5. `create_pages(processSize: int) Page[]`:
...
- `free_properties()` : Libera a memória alocada para os valores das propriedades.
